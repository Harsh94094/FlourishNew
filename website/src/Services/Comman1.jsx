  ...
  return (
    <div className="flex flex-col md:flex-row items-center p-4 md:p-8">
      <div className="md:w-2/3 md:pr-8">
        <h1 className="text-4xl font-bold mb-4">App development company in Ahmedabad</h1>
        <p className="mb-4">
          Welcome to Flourish Creations Pvt. Ltd., the top app development company in Ahmedabad. We specialize in creating cutting-edge mobile applications that empower businesses, engage users, and drive success in the digital age. Let’s explore how we can turn your app idea into reality.
        </p>
        <p className="mb-4">
      ...
      <div className="md:w-1/3">
        <img src="https://teamflourish.co/wp-content/uploads/2023/09/app-deve-02.svg" alt="App Development" className="w-full h-auto" />
      </div>
    </div>
  );
};
